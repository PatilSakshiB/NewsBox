...
export class Navbar extends Component {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/">NewsBox</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item"><a className="nav-link" href="/about">environment</a></li>
        <li className="nav-item"><a className="nav-link" href="/about">food</a></li>
        <li className="nav-item"><a className="nav-link" href="/about">health</a></li>
        <li className="nav-item"><a className="nav-link" href="/about">politics</a></li>
